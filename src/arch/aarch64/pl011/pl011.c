...
/* UART Data Register. */
#define UART_DR IO32_C(UART_BASE + 0x0)

/* Receive Status or Error Clear Register. */
#define UART_RSR_ECR IO32_C(UART_BASE + 0x4)

/* UART Flag Register. */
#define UART_FR IO32_C(UART_BASE + 0x018)

/* UART IBRD (Integer Baudrate) Register. */
#define UART_IBRD IO32_C(UART_BASE + 0x024)

/* UART FBRD (Fractional Baudrate) Register. */
#define UART_FBRD IO32_C(UART_BASE + 0x028)

/* UART Line Control Register Register. */
#define UART_LCR_H IO32_C(UART_BASE + 0x02C)

/* UART Control Register. */
#define UART_CR IO32_C(UART_BASE + 0x030)

/* UART Interrupt Mask Set/Clear Register. */
#define UART_IMSC IO32_C(UART_BASE + 0x038)
...
void plat_console_init(void)
{
	...
	unsigned int quotient = UART_CLOCK * 4 / UART_BAUDRATE;
			  ...
			  struct mpool *ppool)
{
	...
	//TODO: mm_identity_map_and_reserve for device memory
}
